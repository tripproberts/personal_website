...
(function($) {
  ...
  var apiKey,
      ...
      updateTrackInfo = function($player, track) {
        ...
        $('.sc-waveform-container', $player).html('<div class="waveform-bg"><div class="waveform" style="-webkit-mask-box-image:url(' + track.waveform_url +');" ></div></div>');
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $info = $('<div class="sc-info"><h2></h2><h4></h4><p></p></div>').appendTo($player),
        ...
        $player
          .find('.sc-controls')
            .append('<a href="#play" class="sc-play fa fa-play-circle"></a>')
          .end()
